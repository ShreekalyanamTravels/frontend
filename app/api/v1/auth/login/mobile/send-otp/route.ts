...
// Bearer-token (mobile app) counterpart of /api/auth/login/mobile/send-otp — identical logic,
// this endpoint doesn't touch sessions at all so there's nothing to adapt beyond the URL.
