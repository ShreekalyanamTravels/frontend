...
export async function GET(_request: Request, ctx: RouteContext<"/api/bookings/[ref]/ticket">) {
  ...
  // HTML rendering references /airline_icons/{code}.png directly via <img>, so no need to
  // re-encode palette-indexed PNGs the way the react-pdf renderer required.
