...
declare global {
  ...
  var _searchCityCache: Map<string, { data: unknown; expires: number }> | undefined;
}

const cache = global._searchCityCache ?? new Map<string, { data: unknown; expires: number }>();
global._searchCityCache = cache;
